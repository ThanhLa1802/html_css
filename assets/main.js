    ...
    colors.forEach((item, index)=>{
        item.onclick = function (){
            if(index==0){
                ...
                $('.app').classList.remove('christmas');
            }
            if(index==1){
                $('.app').classList.remove('purple_color');
                $('.app').classList.remove('green_color');
    ...
    var Music = {
        ...
        songs: [
                {
                    ...
                    singer_first: 'Đen Vâu ft Nguyên Thảo',
                    singer_second: '',  
                    singer_third: '', 
        ...
        render: function() {
           const htmls  = this.songs.map((song,index) =>{
               console.log(this.currenIndex, index, song)
               return `
